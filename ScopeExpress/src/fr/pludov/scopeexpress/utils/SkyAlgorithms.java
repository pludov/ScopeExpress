...
public static double[] ProperMotion(double epoch, double jd, double ra, double dec, double pm_ra, double pm_dec)
    {
      ...
      ra_out = ra_in + T*pm_ra/(15.0*1000.0*3600.0*cos(dec_in)); 
...
public static double[] GaltoJ2000 (double glon, double glat, double pm_ra, double pm_dec, boolean usePM)
	...
	/**
	 * Retourne le TU pour une valeur d'epoch (ms)
	 * {yr, mo, day, ut (in hours)}
	 */
	public static double [] getCalForEpoch(long when)
	{
		  Calendar now = Calendar.getInstance(TimeZone.getTimeZone("UTC"));
		  now.setTimeInMillis(when);
	      ...
	      return new double[] { year, month, day, ut };
	}
	
	public static int getLeapSecForEpoch(long when)
	{
