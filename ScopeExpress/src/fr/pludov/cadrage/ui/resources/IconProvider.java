package fr.pludov.cadrage.ui.resources;
...
public class IconProvider {
	...
	{
		ImageIcon imageicon = new ImageIcon(IconProvider.class.getResource("/fr/pludov/cadrage/ui/resources/icons/" + fileName + ".png"));
