...
public class AxeAlignDialogDesign extends JDialog {
	...
	public AxeAlignDialogDesign(Window parent) {
		...
		this.tglbtnSpeak.setIcon(new ImageIcon(AxeAlignDialogDesign.class.getResource("/fr/pludov/scopeexpress/ui/resources/icons/text-speak.png")));
		this.toolBar.add(this.tglbtnSpeak);
		
		this.tglbtnAlt = new JToggleButton("");
		this.tglbtnAlt.setIcon(new ImageIcon(AxeAlignDialogDesign.class.getResource("/fr/pludov/scopeexpress/ui/resources/icons/table-border-vertical.png")));
		...
		this.tglbtnAz.setIcon(new ImageIcon(AxeAlignDialogDesign.class.getResource("/fr/pludov/scopeexpress/ui/resources/icons/table-border-horizontal.png")));
