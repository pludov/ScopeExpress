 ...
 * It adds buffering to the RandomAccessFile and also provides efficient
 * handling of arrays. Primitive arrays may be written using a single method
 * call. Large buffers are used to minimize synchronization overheads since
 ...
 * net.ivoa.util.test.BufferedFileTester class.
 * 
 ...
 * 8, 2002: Added getChannel method.
 */
