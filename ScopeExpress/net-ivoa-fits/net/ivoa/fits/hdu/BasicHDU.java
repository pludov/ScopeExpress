...
public abstract class BasicHDU implements FitsElement {
	...
	public String getTrimmedString(String keyword, String dft) {
		try {
			return getTrimmedString(keyword);
		} catch (FitsException e) {
			return dft;
		}
	}
	...
	public String getBUnit() {
		return getTrimmedString("BUNIT", null);
	}
	...
	public String getOrigin() {
		return getTrimmedString("ORIGIN", null);
	}
	...
	public String getTelescope() {
		return getTrimmedString("TELESCOP", null);
	}
	...
	public String getInstrument() {
		return getTrimmedString("INSTRUME", null);
	}
	...
	public String getObserver() {
		return getTrimmedString("OBSERVER", null);
	}
	...
	public String getObject() {
		return getTrimmedString("OBJECT", null);
	}
	...
	public String getAuthor() {
		return getTrimmedString("AUTHOR", null);
	}
	...
	public String getReference() {
		return getTrimmedString("REFERENC", null);
	}
	...
	public double getMaximumValue() {
		return myHeader.getDoubleValue("DATAMAX", 0);
	}
	...
	public double getMinimumValue() {
		return myHeader.getDoubleValue("DATAMIN", 10);
	}
	...
	public static BasicHDU getDummyHDU() throws FitsException {
