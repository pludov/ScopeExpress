   ...
   public JSDebugger(String title) {
       ...
       dim.setGuiCallback(new GuiCallback() {
    	   ...
    	   public void dispatchNextGuiEvent() throws InterruptedException {
    		   debugGui.dispatchNextGuiEvent();
    	   }

    	   @Override
    	   public void enterInterrupt(StackFrame arg0, String arg1, String arg2) {
    		   if (arg2 != null && arg2.equals("org.mozilla.javascript.ContinuationPending")) {
    		   ...
    		   debugGui.enterInterrupt(arg0, arg1, arg2);;
    	   }

    	   @Override
    	   public boolean isGuiEventThread() {
    		   return debugGui.isGuiEventThread();
    	   }

    	   @Override
    	   public void updateSourceText(SourceInfo arg0) {
    		   debugGui.updateSourceText(arg0);
    	   }
       });
