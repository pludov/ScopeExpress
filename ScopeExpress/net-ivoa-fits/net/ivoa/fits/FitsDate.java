...
public class FitsDate {
	...
	public static String getFitsDateString() throws Exception {
	 ...
	 */
	public static String getFitsDateString(Date epoch) throws Exception {
	 ...
	 */
	public static String getFitsDateString(Date epoch, boolean timeOfDay) throws Exception {
